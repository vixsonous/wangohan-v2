...
export default function EditPetDialog({user_id, pet, setPets}: {user_id: number, pet: PetProps, setPets: Dispatch<SetStateAction<Array<PetProps>>>}) {
      ...
      <DialogContent className={"sm:max-w-2xl p-0"}>
        ...
        <ScrollArea className={"max-h-128 px-4 pb-4"}>
          <QueryClientProvider client={queryClient}>
            <PetForm user_id={user_id} pet={pet} setOpen={setOpen} setPets={setPets}/>
          </QueryClientProvider>
        </ScrollArea>
      </DialogContent>
    </Dialog>
