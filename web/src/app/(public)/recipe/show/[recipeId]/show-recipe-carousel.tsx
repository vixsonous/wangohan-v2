...
export default function ShowRecipeCarousel() {
  ...
  return (
    <Carousel setApi={setApi} className="max-w-3xl w-3xl relative">
      <CarouselContent>
            ...
            <CarouselItem key={a}>
              <Card className="p-0">
                <CardContent className="relative flex items-center justify-center p-0 ">
                  ...
                  <Image src={"/image.webp"} className="object-contain relative h-[100%] rounded-[0px] w-[100%] max-w-none" width={768} alt="website banner" />
                </CardContent>
              </Card>
            </CarouselItem>
          )
      ...
      <Carousel className="pt-4">
        <CarouselContent className="-ml-1">
          {Array.from(Array(length).keys()).map(a => {
            return (
              <CarouselItem className={`basis-1/5 pl-1`} key={a}>
