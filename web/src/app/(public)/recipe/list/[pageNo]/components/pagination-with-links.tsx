...
export function PaginationWithLinks({
  ...
  const buildLink = useCallback(
    (newPage: number) => {
      const getLastSlashIndex = pathname.lastIndexOf("/");
      const listPathName = pathname.slice(0, getLastSlashIndex);
  ...
  return (
    <div className="flex pt-8 text-primary-text flex-col md:flex-row items-center gap-3 w-full">
      {pageSizeSelectOptions && (
