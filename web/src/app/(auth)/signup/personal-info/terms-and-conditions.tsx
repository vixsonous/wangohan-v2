...
export default function TermsAndConditions() {
  return (
    <Dialog>
      ...
      <DialogContent className={"max-h-3/4 overflow-y-scroll"}>
        <DialogHeader>
        ...
        <div>
          ...
          <div className="tos-div flex flex-col gap-[15px] text-xs mt-[15px]">
            <div>
            ...
            <div>
              <h1 className="font-bold">第2条（利用登録）</h1>
              <ol className="list-decimal list-inside flex flex-col">
                ...
                <li>
                  ...
                  <ol className="list-[lower-alpha] list-inside ml-[10px]">
            ...
            <div>
              <h1 className="font-bold">第3条（ユーザーIDおよびパスワードの管理）</h1>
              <ol className="list-decimal list-inside flex flex-col">
            ...
            <div>
              <h1 className="font-bold">第4条（禁止事項）</h1>
            ...
            <div>
              <h1 className="font-bold">第5条（本サービスの提供の停止等）</h1>
              <ol className="list-decimal list-inside flex flex-col">
                <li>
            ...
            <div>
              <h1 className="font-bold">第6条（利用制限および登録抹消）</h1>
              <ol className="list-decimal list-inside flex flex-col">
                <li>
            ...
            <div>
              <h1 className="font-bold">第7条（保証の否認および免責事項）</h1>
              <ol className="list-decimal list-inside flex flex-col">
                ...
                <li>当サイトは，本サービスに起因してユーザーに生じたあらゆる損害について、当サイトの故意又は重過失による場合を除き、一切の責任を負いません。ただし，本サービスに関する当サイトとユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合，この免責規定は適用されません。</li>
            ...
            <div>
              <h1 className="font-bold">第8条（サービス内容の変更等）</h1>
              <span>当サイトは，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。 </span>
            </div>

            <div>
              <h1 className="font-bold">第9条（利用規約の変更）</h1>
              <ol className="list-decimal list-inside flex flex-col">
                <li>
                ...
                <li>当サイトはユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨及び変更後の本規約の内容並びにその効力発生時期を通知します。</li>
              </ol>
            </div>

            <div>
              <h1 className="font-bold">第10条（個人情報の取扱い）</h1>
              <span>当サイトは，本サービスの利用によって取得する個人情報については，当サイト「プライバシーポリシー」に従い適切に取り扱うものとします。</span>
            </div>

            <div>
              <h1 className="font-bold">第11条（通知または連絡）</h1>
              <span>ユーザーと当サイトとの間の通知または連絡は，当サイトの定める方法によって行うものとします。当サイトは,ユーザーから,当サイトが別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。</span>
            </div>

            <div>
              <h1 className="font-bold">第12条（権利義務の譲渡の禁止）</h1>
              <span>ユーザーは，当サイトの書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</span>
            </div>

            <div>
              <h1 className="font-bold">第13条（準拠法・裁判管轄）</h1>
              <ol className="list-decimal list-inside flex flex-col">
