...
import {deleteRecipe, setPublishRecipe} from "@/app/(protected-admin)/admin/dashboard/components/recipe/recipe-slice";
...
export function RecipePublish({ publishMutation, dispatch, recipe_id, is_published}: {recipe_id: number, is_published: boolean, publishMutation: PublishMutationType, dispatch: DispatchType}) {
